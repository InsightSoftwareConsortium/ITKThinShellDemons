...
#ifndef kwssys_Configure_h
#define kwssys_Configure_h
...
#define kwssys_NAME_IS_KWSYS 0

/* Setup the export macro.  */
#if 0
#  if defined(_WIN32) || defined(__CYGWIN__)
#    if defined(kwssys_EXPORTS)
#      define kwssys_EXPORT __declspec(dllexport)
#    else
#      define kwssys_EXPORT __declspec(dllimport)
#    endif
#  elif __GNUC__ >= 4
#    define kwssys_EXPORT __attribute__((visibility("default")))
#  else
#    define kwssys_EXPORT
#  endif
#else
#  define kwssys_EXPORT
#endif
...
#if !defined(kwssys_NO_WARNING_ENABLE)
#  if defined(_MSC_VER)
...
#if !defined(kwssys_NO_WARNING_DISABLE)
#  if defined(_MSC_VER)
...
/* MSVC 6.0 in release mode will warn about code it produces with its
   ...
   by other compilers.  */
#if !defined(kwssys_NO_WARNING_DISABLE_BOGUS)
