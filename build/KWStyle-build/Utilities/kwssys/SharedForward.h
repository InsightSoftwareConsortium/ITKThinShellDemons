...
#ifndef kwssys_SharedForward_h
#  define kwssys_SharedForward_h
...
/*
  ...
  #endif
  #define kwssys_SHARED_FORWARD_DIR_BUILD "/path/to/foo-build/bin"
  #define kwssys_SHARED_FORWARD_PATH_BUILD "." CONFIG_DIR_POST
  #define kwssys_SHARED_FORWARD_PATH_INSTALL "../lib/foo-1.2"
  #define kwssys_SHARED_FORWARD_EXE_BUILD CONFIG_DIR_PRE "foo-real"
  #define kwssys_SHARED_FORWARD_EXE_INSTALL
  "../lib/foo-1.2/foo-real"
  #define kwssys_SHARED_FORWARD_OPTION_COMMAND "--command"
  #define kwssys_SHARED_FORWARD_OPTION_PRINT "--print"
  #define kwssys_SHARED_FORWARD_OPTION_LDD "--ldd"
  #if defined(CMAKE_INTDIR)
  # define kwssys_SHARED_FORWARD_CONFIG_NAME CMAKE_INTDIR
  #endif
  #include <kwssys/SharedForward.h>
  int main(int argc, char** argv)
  {
    return kwssys_shared_forward_to_real(argc, argv);
  }
  ...
  #define kwssys_SHARED_FORWARD_PATH_BUILD \
          "." CONFIG_DIR_POST, "/path/to/bar-build" CONFIG_DIR_POST
  #define kwssys_SHARED_FORWARD_PATH_INSTALL \
...
static int kwssys_shared_forward_to_real(int argc, char** argv_in)
{
...
#else
#  error "kwssys/SharedForward.h should be included only once."
#endif
