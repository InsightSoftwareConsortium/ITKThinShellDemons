...
#ifndef kwssys_Encoding_hxx
#define kwssys_Encoding_hxx
...
namespace kwssys {
class kwssys_EXPORT Encoding
{
public:
  // Container class for argc/argv.
  class kwssys_EXPORT CommandLineArguments
  {
  public:
