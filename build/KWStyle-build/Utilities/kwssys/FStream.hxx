...
#ifndef kwssys_FStream_hxx
#define kwssys_FStream_hxx

#include <kwssys/Configure.hxx>

#include <kwssys/Encoding.hxx>

#include <fstream>
#if defined(_WIN32)
#  if !defined(_MSC_VER) && kwssys_CXX_HAS_EXT_STDIO_FILEBUF_H
...
namespace kwssys {
#if defined(_WIN32) &&                                                        \
  (defined(_MSC_VER) || kwssys_CXX_HAS_EXT_STDIO_FILEBUF_H)
#  if defined(_NOEXCEPT)
#    define kwssys_FStream_NOEXCEPT _NOEXCEPT
#  else
#    define kwssys_FStream_NOEXCEPT
#  endif
...
public:
  ...
  ~basic_fstream() kwssys_FStream_NOEXCEPT { close(); }
};
...
public:
  ...
  ~basic_ifstream() kwssys_FStream_NOEXCEPT { close(); }
};
...
public:
  ...
  ~basic_ofstream() kwssys_FStream_NOEXCEPT { close(); }
};
...
// seekable stream).
kwssys_EXPORT BOM ReadBOM(std::istream& in);
}
}
