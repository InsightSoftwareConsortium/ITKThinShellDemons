...
#ifndef kwssys_SystemTools_hxx
#define kwssys_SystemTools_hxx

#include <kwssys/Configure.hxx>
#include <kwssys/Status.hxx>
...
namespace kwssys_VA_LIST {
using namespace std;
typedef va_list hack_va_list;
}
namespace kwssys {
typedef kwssys_VA_LIST::hack_va_list va_list;
}
#endif // va_list
 ...
 */
class kwssys_EXPORT SystemToolsManager
{
public:
  SystemToolsManager();
  ~SystemToolsManager();
 ...
 */
class kwssys_EXPORT SystemTools
{
public:
  /** -----------------------------------------------------------------
...
#if kwssys_SYSTEMTOOLS_USE_TRANSLATION_MAP
  /**
