...
int itkThinShellDemonsTest(int, char*[]);
int itkThinShellDemonsTestv4_Affine(int, char*[]);
int itkThinShellDemonsTestv4_Displacement(int, char*[]);
int itkThinShellDemonsTestv4_SyN(int, char*[]);
