...
public:
   ...
   */
  virtual MeasureType
  GetLocalNeighborhoodValue(const PointIdentifier,
                            const PointType &,
  ...
  GetLocalNeighborhoodDerivative(const PointIdentifier,
                                 const PointType &,
   ...
   */
  virtual void
  GetLocalNeighborhoodValueAndDerivative(const PointIdentifier,
                                         const PointType &,
                                         MeasureType &,
                                         LocalDerivativeType &,
                                         const PixelType & pixel) const = 0;
